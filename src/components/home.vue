...
<style>
  ...
  .inspect .item_gover_title {
    background: url(../../static/images/inspect_bg.png) no-repeat !important;
  }
  .stat .item_gover_title {
    background: url(../../static/images/stat_bg.png) no-repeat !important;
  }
